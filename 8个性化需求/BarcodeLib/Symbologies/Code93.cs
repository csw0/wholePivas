...
namespace BarcodeLib
{
    class Code93 : BarcodeCommon, IBarcode
    {
        ...
        private void init_Code93()
        {
            ...
            C93_Code.Rows.Add(new object[] { "43", "(", "110101110" });//dont know what character actually goes here
            C93_Code.Rows.Add(new object[] { "44", ")", "110101110" });//dont know what character actually goes here
            C93_Code.Rows.Add(new object[] { "45", "#", "110101110" });//dont know what character actually goes here
            C93_Code.Rows.Add(new object[] { "46", "@", "110101110" });//dont know what character actually goes here
