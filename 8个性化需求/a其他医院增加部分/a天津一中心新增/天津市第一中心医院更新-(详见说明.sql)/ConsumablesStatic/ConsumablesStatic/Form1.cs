...
namespace ConsumablesStatic
{
    public partial class Form1 : Form
    {
        ...
        {
            WritePrivateProfileString("ConsumablesName", "hc1", this.textBox4.Text, ".\\ConsumablesStatic.ini");
            WritePrivateProfileString("ConsumablesName", "hc2", this.textBox5.Text, ".\\ConsumablesStatic.ini");
            WritePrivateProfileString("ConsumablesName", "hc3", this.textBox6.Text, ".\\ConsumablesStatic.ini");
            WritePrivateProfileString("ConsumablesName", "hc4", this.textBox7.Text, ".\\ConsumablesStatic.ini");
            WritePrivateProfileString("ConsumablesName", "hc5", this.textBox8.Text, ".\\ConsumablesStatic.ini");
            WritePrivateProfileString("ConsumablesName", "hc6", this.textBox9.Text, ".\\ConsumablesStatic.ini");
            WritePrivateProfileString("ConsumablesName", "hc7", this.textBox10.Text, ".\\ConsumablesStatic.ini");
            WritePrivateProfileString("ConsumablesName", "hc8", this.textBox11.Text, ".\\ConsumablesStatic.ini");
        ...
        private string[] getSelectHC()
        {
            ...
            GetPrivateProfileString("ConsumablesName", "hc1", "", stringBuilder1, 255, ".\\ConsumablesStatic.ini");
            string hc1 = stringBuilder1.ToString();
            GetPrivateProfileString("ConsumablesName", "hc2", "", stringBuilder2, 255, ".\\ConsumablesStatic.ini");
            string hc2 = stringBuilder2.ToString();
            GetPrivateProfileString("ConsumablesName", "hc3", "", stringBuilder3, 255, ".\\ConsumablesStatic.ini");
            string hc3 = stringBuilder3.ToString();
            GetPrivateProfileString("ConsumablesName", "hc4", "", stringBuilder4, 255, ".\\ConsumablesStatic.ini");
            string hc4 = stringBuilder4.ToString();
            GetPrivateProfileString("ConsumablesName", "hc5", "", stringBuilder5, 255, ".\\ConsumablesStatic.ini");
            string hc5 = stringBuilder5.ToString();
            GetPrivateProfileString("ConsumablesName", "hc6", "", stringBuilder6, 255, ".\\ConsumablesStatic.ini");
            string hc6 = stringBuilder6.ToString();
            GetPrivateProfileString("ConsumablesName", "hc7", "", stringBuilder7, 255, ".\\ConsumablesStatic.ini");
            string hc7 = stringBuilder7.ToString();
            GetPrivateProfileString("ConsumablesName", "hc8", "", stringBuilder8, 255, ".\\ConsumablesStatic.ini");
            string hc8 = stringBuilder8.ToString();
            GetPrivateProfileString("ChargeItem", "PTY", "", stringBuilder9, 255, ".\\ConsumablesStatic.ini");
            string pt = stringBuilder9.ToString();
            GetPrivateProfileString("ChargeItem", "KSS", "", stringBuilder10, 255, ".\\ConsumablesStatic.ini");
            string kss = stringBuilder10.ToString();
            GetPrivateProfileString("ChargeItem", "HLY", "", stringBuilder11, 255, ".\\ConsumablesStatic.ini");
            string hl = stringBuilder11.ToString();
            GetPrivateProfileString("ChargeItem", "YYY", "", stringBuilder12, 255, ".\\ConsumablesStatic.ini");
            string yyy = stringBuilder12.ToString();
            GetPrivateProfileString("ChargeItem", "PZL", "", stringBuilder13, 255, ".\\ConsumablesStatic.ini");
            string pzl = stringBuilder13.ToString();
            GetPrivateProfileString("ChargeItem", "KZL", "", stringBuilder14, 255, ".\\ConsumablesStatic.ini");
            string kzl = stringBuilder14.ToString();
            GetPrivateProfileString("ChargeItem", "HZL", "", stringBuilder15, 255, ".\\ConsumablesStatic.ini");
            string hzl = stringBuilder15.ToString();
            GetPrivateProfileString("ChargeItem", "YZL", "", stringBuilder16, 255, ".\\ConsumablesStatic.ini");
            string yzl = stringBuilder16.ToString();
            GetPrivateProfileString("ChargeItem", "XL", "", stringBuilder17, 255, ".\\ConsumablesStatic.ini");
            string xl = stringBuilder17.ToString();
            GetPrivateProfileString("ChargeItem", "KW", "", stringBuilder18, 255, ".\\ConsumablesStatic.ini");
            string kw = stringBuilder18.ToString();
            GetPrivateProfileString("ChargeItem", "XLZL", "", stringBuilder19, 255, ".\\ConsumablesStatic.ini");
            string xlzl = stringBuilder19.ToString();
            GetPrivateProfileString("ChargeItem", "KWZL", "", stringBuilder20, 255, ".\\ConsumablesStatic.ini");
            string kwzl = stringBuilder20.ToString();
            
            string[] str = { hc1, hc2, hc3, hc4, hc5, hc6, hc7, hc8, pt, kss, hl, yyy, pzl, kzl, hzl, yzl, xl, kw, xlzl, kwzl };
            return str;
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //this.checkBox1.Text = str[5].ToString();
            //this.checkBox1.Text = str[6].ToString();
            //this.checkBox1.Text = str[7].ToString();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (this.radioButton1.Checked)
                WritePrivateProfileString("ChargeItem", "PTY", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else if (this.radioButton2.Checked)
                WritePrivateProfileString("ChargeItem", "KSS", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else if (this.radioButton3.Checked)
                WritePrivateProfileString("ChargeItem", "HLY", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else if (this.radioButton4.Checked)
                WritePrivateProfileString("ChargeItem", "YYY", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else if (this.radioButton5.Checked)
                WritePrivateProfileString("ChargeItem", "XL", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else
                WritePrivateProfileString("ChargeItem", "KW", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            ...
            if (this.radioButton1.Checked)
                WritePrivateProfileString("ChargeItem", "PZL", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else if (this.radioButton2.Checked)
                WritePrivateProfileString("ChargeItem", "KZL", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else if (this.radioButton3.Checked)
                WritePrivateProfileString("ChargeItem", "HZL", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else if(this.radioButton4.Checked)
                WritePrivateProfileString("ChargeItem", "YZL", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else if (this.radioButton5.Checked)
                WritePrivateProfileString("ChargeItem", "XLZL", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            else
                WritePrivateProfileString("ChargeItem", "KWZL", this.textBox14.Text, ".\\ConsumablesStatic.ini");
            //MessageBox.Show((aa + bb).ToString());
        }
