...
namespace BLPublic
{
    public class OLEDB_DBOperator
    {
        private OLEDB_Oracle_SQLServer conn;
        ...
        {
            return this.conn.UpdateClob(update, clobValue);
        }

        public int UpdateClob(string update, List<string> clobValues)
        {
            
            return this.conn.UpdateClob(update, clobValues);
        }
        #endregion
