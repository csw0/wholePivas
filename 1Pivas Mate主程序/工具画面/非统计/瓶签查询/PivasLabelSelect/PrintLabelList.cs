...
{
    public partial class PrintLabelList : Form
    {
        public PrintLabelList()
        {
            InitializeComponent();
        }
        public PrintLabelList(DataTable dt,string title,string count)
        {
            InitializeComponent();
            this.dt = dt;           
            this.Title = title;
        ...
        public PrintLabelList(DataTable dt, string title, string count,string labelNos)
        {
            InitializeComponent();
            this.dt = dt;
